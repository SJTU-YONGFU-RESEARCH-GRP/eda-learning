# Checklist — Timing-driven placement

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **timing-weighted HPWL placement objective** end-to-end on the starter placement
- [ ] Reported HPWL (and density / overflow when the lab uses them)
- [ ] Can explain the algorithm steps without the UI

## Track B — Browser lab (`timing-driven-place`)
