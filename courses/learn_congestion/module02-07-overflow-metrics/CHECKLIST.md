# Checklist — Overflow metrics

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **overflow metrics (total, max, congested count)** end-to-end on `examples/tiny_cong.json`
- [ ] Reported demand / congestion / overflow when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`overflow-metrics`)
