# Checklist — RUDY congestion estimate

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **RUDY (Rectangular Uniform wire DensitY) demand estimate** end-to-end on `examples/tiny_cong.json`
- [ ] Reported demand / congestion / overflow when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`rudy-estimate`)
