# Checklist — A* detailed routing

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **A* detailed routing (congestion-aware grid search)** end-to-end on `examples/tiny_dr.json`
- [ ] Reported track usage / overflow when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`astar-route`)
