# Checklist — Via assignment (2-layer)

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **two-layer via assignment on L-shaped paths** end-to-end on `examples/tiny_dr.json`
- [ ] Reported track usage / overflow when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`via-assignment`)
