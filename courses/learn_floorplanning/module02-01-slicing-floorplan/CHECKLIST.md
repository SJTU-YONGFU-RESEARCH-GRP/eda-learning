# Checklist — Slicing tree / polish expression packing

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **slicing tree / polish expression packing (H and V cuts)** end-to-end on the starter modules
- [ ] Reported legality (in-outline, no overlap), area, density, and deadspace
- [ ] Can explain the representation / move without the UI

## Track B — Browser lab (`slicing-floorplan`)
