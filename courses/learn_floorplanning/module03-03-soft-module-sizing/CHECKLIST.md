# Checklist — Soft module aspect sizing

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **soft-module aspect-ratio sizing under fixed outline** end-to-end on the starter modules
- [ ] Reported legality (in-outline, no overlap), area, density, and deadspace
- [ ] Can explain the representation / move without the UI

## Track B — Browser lab (`soft-module-sizing`)
