# Checklist — Multi-pin tree (Steiner-lite)

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **multipin star tree (bbox-center Steiner-lite)** end-to-end on `examples/tiny_gr.json`
- [ ] Reported edge usage / overflow when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`multipin-tree`)
