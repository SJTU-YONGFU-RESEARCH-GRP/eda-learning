# Checklist — Sequential global route

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **sequential global routing (ordered net deposit)** end-to-end on `examples/tiny_gr.json`
- [ ] Reported edge usage / overflow when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`sequential-global`)
