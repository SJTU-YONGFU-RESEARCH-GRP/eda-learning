# Checklist — Maze routing on GCells

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **maze routing (BFS with edge capacity)** end-to-end on `examples/tiny_gr.json`
- [ ] Reported edge usage / overflow when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`maze-gcell-route`)
