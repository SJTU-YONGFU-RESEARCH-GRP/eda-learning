# Module 00-00: Welcome to legalization for EDA

**Module id:** `module00-00-intro`  
**Kind:** `intro` · Dual-track course welcome

← Start · [Course README](../README.md) · [Site / row →](../module01-01-site-row-model/README.md)
...
→ [Module 01-01: Site and row model](../module01-01-site-row-model/README.md)
