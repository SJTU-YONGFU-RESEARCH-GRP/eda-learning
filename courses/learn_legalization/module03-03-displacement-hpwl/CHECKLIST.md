# Checklist — Displacement vs HPWL tradeoff

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **displacement sum vs HPWL tradeoff metrics** end-to-end on `examples/tiny_legal.json`
- [ ] Reported legality (row, site, non-overlap) and displacement / HPWL when relevant
- [ ] Can explain the algorithm without the UI

## Track B — Browser lab (`displacement-hpwl`)
