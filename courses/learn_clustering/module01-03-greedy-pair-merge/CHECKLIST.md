# Checklist — Greedy pair merge

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **greedy pair merge (heaviest-edge matching coarsening)** end-to-end on the starter graph
- [ ] Reported cutsize, balance (or capacity), and objective score
- [ ] Can explain the algorithm steps without the UI

## Track B — Browser lab (`greedy-pair-merge`)
