...
After this module you can: **Weight edges by timing criticality / slack and optimize a timing-aware objective.**

## Two tracks (pick one or both)

### Track A — Implement (hands-on)

1. Open [EXAMPLES.md](EXAMPLES.md) and implement **timing-weighted clustering objective** on the tiny graphs.
