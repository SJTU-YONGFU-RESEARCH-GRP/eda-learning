# Fiduccia–Mattheyses refinement — step-by-step (for slides / transcript)

**Module:** `module02-07-fiduccia-mattheyses`  
**Lab / algo:** `fiduccia-mattheyses`  
**Viewer:** `/tools/algorithm-walkthrough/?algo=fiduccia-mattheyses&step=1`
