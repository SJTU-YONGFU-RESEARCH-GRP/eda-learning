...
After this module you can: **Model nets as hyperedges and cluster / cut with a hypergraph objective.**

## Two tracks (pick one or both)

### Track A — Implement (hands-on)

1. Open [EXAMPLES.md](EXAMPLES.md) and implement **hypergraph clustering / netlist cut modeling** on the tiny graphs.
