# Spectral bisection — step-by-step (for slides / transcript)

**Module:** `module02-03-spectral-bisection`  
**Lab / algo:** `spectral-bisection`  
**Viewer:** `/tools/algorithm-walkthrough/?algo=spectral-bisection&step=1`
...
**Caption (transcript):** Spectral recovers the same communities as unconstrained greedy and LP. Teaching point: global eigenvectors can find the cut without greedy merges.
...
**Caption (transcript):** Spectral is a strong initializer for bipartition. On larger chips it pairs with multilevel; here the tiny instance is exact enough to grade against goldens.
