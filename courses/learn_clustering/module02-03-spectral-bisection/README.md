...
After this module you can: **Build the Laplacian, take the Fiedler vector, and bisect with balance constraints.**

## Two tracks (pick one or both)

### Track A — Implement (hands-on)

1. Open [EXAMPLES.md](EXAMPLES.md) and implement **spectral bisection (Laplacian / Fiedler)** on the tiny graphs.
