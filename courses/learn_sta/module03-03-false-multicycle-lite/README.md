...
**Kind:** `lab` · Primary lab: `false-multicycle-lite` · **Planned**
...
1. Local: [http://127.0.0.1:8080/tools/false-multicycle-lite/index.html](http://127.0.0.1:8080/tools/false-multicycle-lite/index.html) *(planned)*
2. Tools shelf: open `false-multicycle-lite` from the platform tools index when shipped
