...
Status: **ref** = browser lab + `common/` solvers shipped.
...
| `module01-03-arrival-required` | `lab` | [Arrival and required times](../module01-03-arrival-required/README.md) | `arrival-required` | **ref** |
| `module02-01-slack-setup-hold` | `lab` | [Slack, setup, and hold](../module02-01-slack-setup-hold/README.md) | `slack-setup-hold` | **ref** |
| `module02-03-critical-path` | `lab` | [Critical path](../module02-03-critical-path/README.md) | `critical-path` | **ref** |
| `module03-01-incremental-update` | `lab` | [Incremental timing update](../module03-01-incremental-update/README.md) | `incremental-update` | **ref** |
| `module03-03-false-multicycle-lite` | `lab` | [False and multicycle paths (engine view)](../module03-03-false-multicycle-lite/README.md) | `false-multicycle-lite` | **ref** |
...
Step frames + captions for **all 6 algorithm labs**: [WALKTHROUGHS.md](WALKTHROUGHS.md).
