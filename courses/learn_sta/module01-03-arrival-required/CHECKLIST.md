# Checklist — Arrival and required times

## Track A — Implement

- [ ] Worked through the prompts in [EXAMPLES.md](EXAMPLES.md)
- [ ] Implemented **forward arrival and backward required propagation** end-to-end on the starter netlist
- [ ] Reported arrivals, required times, and/or slack as the module requires
- [ ] Can explain the algorithm steps without the UI

## Track B — Browser lab (`arrival-required`)
